...
?><!DOCTYPE html><html lang="en"><head><?php
        ...
        ?><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="stylesheet" href="./modules/yugal.css"><script src="modules/mod.js"></script><?php
        ...
        ?>
            ...
            <link rel="apple-touch-icon-precomposed" sizes="114x114" href="i<?php echo $favicon[0]; ?>">
            <!--iPhone Retina -->
            <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo $favicon[0]; ?>"><!-- iPad 1 e 2 -->
            <link rel="apple-touch-icon-precomposed" href="<?php echo $favicon[0]; ?>"><!-- iPhone, iPod e Android 2.2+ --><?php
                                                                                                                        }
                echo $common_head_tag; ?><!--PAGE SPECIFIC <head> CODE BELOW--><!-- DO NOT REMOVE THE COMMENT ABOVE OR SCREEN SPECIFIC HEAD CODE MAY BREAK --></head><body><noscript><?php 
                echo str_replace("\n", "", $noscript_tag);
                ?></noscript><?php
    if ($key === "library") {
        foreach ($val as $each) {
